...
#******************************
    ...
    my($table, $parent_dir) = $c->menu->find( $level, 
                                              ['title_alias', 'parent_dir'], 
    ...
    my $numb_items_for_parent_dir = $c->menu->find( $level, 
                                                    ['count(parent_dir)'], 
    ...
    if(!$numb_items_for_parent_dir){
        ...
        if(!$numb_items_for_parent_dir && $parent_dir ne 'main'){
            $c->db_table->drop_tbl( $c, $parent_dir);
        }
